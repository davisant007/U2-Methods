...
public class BankAccount {
    ...
    public static void deposit() {
        ...
        JOptionPane.showMessageDialog(null, "Your new balence is: " + balance);
    ...
    public static void withdrawal() {
        ...
        double balance = Double.parseDouble(JOptionPane.showInputDialog("what is your current balance "));
        double withdrawal = Double.parseDouble(JOptionPane.showInputDialog("what is your deposit amount"));
